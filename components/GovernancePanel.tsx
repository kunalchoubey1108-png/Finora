...
export function GovernancePanel({ summary }: { summary: GovernanceSummary }) {
  return (
    <Card className="space-y-5">
      ...
      <p className="text-sm leading-7 text-brand.muted">{summary.riskNote}</p>
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="rounded-2xl bg-brand-surface/70 p-4">
          <p className="text-sm uppercase tracking-[0.16em] text-brand.muted">
            Assigned reviewer
          </p>
